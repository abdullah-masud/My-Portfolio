...
import resume from '../../assets/portfolio/Resume-Masud.pdf'
            ...
            <div className='container h-full max-w-7xl mx-auto '>
                <div className='flex items-center h-full pt-8'>
                    <div className='flex-1 flex flex-col items-center lg:items-start'>
                        ...
                        <h1 className='text-4xl text-white font-primary leading-[44px] md:text-5xl md:leading-tight lg:text-7xl lg:leading-[1.2] font-bold md:tracking-[-2px]'>
                            I Build & Design <br /> Web Interfaces.
                        </h1>
                        <div className='lg:flex gap-3 lg:mt-0 mt-5'>
